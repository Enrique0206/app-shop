	...
	<div class="main main-raised">
		<div class="container">
	        ...
	        <div class="section">
				...
				<!--mostrando alerta de errores para editar-->
				@if ($errors->any())
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group label-floating">
								...
								<input type="text" class="form-control" name="name" value="{{ old('name', $product->name) }}"> <!--con este value mostramos el valor del precio en caso no lo hubiera mostraemos el actual-->
							</div>
						</div>
